  ...
  return (
    <div className="p-6 md:p-10 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        ...
        <Link href={createHref} className="clay-button px-8 py-4 rounded-2xl font-bold flex items-center gap-2 text-white transition-all active:scale-95">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
         {adOptions.map((opt, i) => {
           ...
           const wrapperProps = isComingSoon ? {} : { href: isMember === false ? '/upgrade' : opt.href };
           return (
             <CardWrapper key={i} {...(wrapperProps as any)}>
               <motion.div 
