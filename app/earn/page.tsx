...
export default function EarnPage() {
  ...
  const handleTaskClick = async (task: Task) => {
   ...
   return (
    <div className="p-6 md:p-10 max-w-5xl mx-auto pb-40 relative z-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        <div>
           <h1 className="text-3xl font-bold text-white mb-1 tracking-tight">Rewards Hub</h1>
           <p className="text-white/40 text-sm font-medium">Complete quick missions for instant cash</p>
        </div>
        <div className="glass px-6 py-4 flex items-center gap-4 border-white/5 bg-white/[0.01]">
      ...
      {loading ? (
        ...
        <div className="glass p-16 text-center border-white/5 mx-auto max-w-sm rounded-[2.5rem]">
           ...
           <p className="text-white/40 text-sm mb-8 font-medium">You've finished all available tasks. Check back later for more!</p>
